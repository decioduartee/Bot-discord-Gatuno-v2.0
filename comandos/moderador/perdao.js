...
module.exports = {
    ...
    run: async (client, message, args, database) => {
        ...
        const content = Content => Content || membro.user.displayAvatarURL({ format: "png", size: 2048, dynamic: true });
  
        const embed = new MessageEmbed()
            .setColor("#2f3136")
            .setThumbnail(content('https://cdn.discordapp.com/attachments/705905702648152144/746948905953918978/sem_foto.png'))
