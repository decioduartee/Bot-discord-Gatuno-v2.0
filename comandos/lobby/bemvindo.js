        ...
        const embed = new MessageEmbed()
            ...
            let cj = message.channel.createMessageCollector(x => x.author.id == message.author.id, {
                ...
                .on('collect', c => {
                    ...
                    database.ref(`/Servidores/${message.guild.id}/Lobby/Bemvido/Mensagem`).set(texto)
                    ...
                    message.channel.send(embed2).then(msg2 => {
                        ...
                        let cjj = message.channel.createMessageCollector(x => x.author.id == message.author.id, {
                            ...
                            .on('collect', c => {
                                ...
                                database.ref(`/Servidores/${message.guild.id}/Lobby/Bemvido/Titulo`).set(titulo)

                                const embed3 = new MessageEmbed()
                                    .setTitle(`__CANAL__`)
                                    .setColor('#2f3136')
                                    .setDescription(`<:listadecomandos:706682302989860876> » Por fim, mencione o canal que deseja definir como de boas-vindas`)
                                ...
                                message.channel.send(embed3).then(msg3 => {
                                    ...
                                    database.ref(`/Servidores/${message.guild.id}/Lobby/Bemvido/Canal`).set(canal.id)

                                const pronto = new MessageEmbed()
                                    .setColor("#2f3136")
                                    .setDescription(`**Pronto** ${message.author}, Sistema de entrada configurado com sucesso!`)
