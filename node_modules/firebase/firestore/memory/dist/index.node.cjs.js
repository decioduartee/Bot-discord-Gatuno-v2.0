...
function E$1(t) {
    ...
    if (w$1.logLevel <= LogLevel.DEBUG) {
        var i = e.map(A$1);
        w$1.debug.apply(w$1, __spreadArrays([ "Firestore (7.17.2): " + t ], i));
    }
}
...
function I$1(t) {
    ...
    if (w$1.logLevel <= LogLevel.ERROR) {
        var i = e.map(A$1);
        w$1.error.apply(w$1, __spreadArrays([ "Firestore (7.17.2): " + t ], i));
    }
}
...
function N$1(t) {
    ...
    if (w$1.logLevel <= LogLevel.WARN) {
        var i = e.map(A$1);
        w$1.warn.apply(w$1, __spreadArrays([ "Firestore (7.17.2): " + t ], i));
    }
}
 ...
 */ var k$1 = /** @class */ function() {
    ...
    return t.t = function() {
        ...
        ; n.length < 20; ) for (var r = V$1(40), i = 0; i < r.length; ++i) 
...
/** Helper to compare arrays using isEqual(). */ function O$1(t, e, n) {
...
function(t, e, n, r, i) {
    ...
    return Object.defineProperty(t.prototype, "i", {
        ...
        return R$1(this.projectId, t.projectId) || R$1(this.database, t.database);
    }, t;
}();
 ...
 */ var C$1 = /** @class */ function() {
    ...
    return t.now = function() {
        ...
        return this.seconds === t.seconds ? R$1(this.nanoseconds, t.nanoseconds) : R$1(this.seconds, t.seconds);
...
}(j), B = /^[_a-zA-Z][_a-zA-Z0-9]*$/, K$1 = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return __extends(n, e), n.prototype.V = function(t, e, r) {
...
}(j), W$1 = /** @class */ function() {
    function t(t) {
        this.path = t;
    }
    return t.U = function(e) {
        return new t(z.$(e).p(5));
    }, 
...
function X$1(t) {
    ...
    if (null === e.G) {
        ...
        null !== e.collectionGroup && (n += "|cg:" + e.collectionGroup), n += "|f:", n += e.filters.map((function(t) {
            ...
            var e;
        })).join(","), Q$1(e.limit) || (n += "|l:", n += e.limit), e.startAt && (n += "|lb:", 
        n += Dn(e.startAt)), e.endAt && (n += "|ub:", n += Dn(e.endAt)), e.G = n;
    }
    return e.G;
}
...
function J$1(t, e) {
    ...
    for (var n = 0; n < t.orderBy.length; n++) if (!Pn(t.orderBy[n], e.orderBy[n])) return !1;
...
function Z$1(t) {
    return W$1.W(t.path) && null === t.collectionGroup && 0 === t.filters.length;
}
...
var et, nt, rt = /** @class */ function() {
     ...
     */ , s) {
        void 0 === i && (i = G$1.min()), void 0 === o && (o = G$1.min()), void 0 === s && (s = tt.Y), 
...
var ut = /** @class */ function() {
    ...
    t.prototype.vt = function() {
        if (this.Rt() && this.left.Rt()) throw T$1();
        if (this.right.Rt()) throw T$1();
        var t = this.left.vt();
        if (t !== this.right.vt()) throw T$1();
...
var gt = new ut(W$1.P), mt = new ht(W$1.P);
 ...
 */ var It = /** @class */ function() {
    ...
    function t(t) {
        ...
        this.P = t ? function(e, n) {
            return t(e, n) || W$1.P(e.key, n.key);
        } : function(t, e) {
            return W$1.P(t.key, e.key);
    ...
    return t.Bt = function(e, n, r, i) {
        ...
        if (!(this.fromCache === t.fromCache && this.Mt === t.Mt && this.qt.isEqual(t.qt) && yn(this.query, t.query) && this.docs.isEqual(t.docs) && this.Ot.isEqual(t.Ot))) return !1;
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, _t.Kt(e, n)), new t(G$1.min(), r, Et(), pt(), wt());
    }, t;
}(), _t = /** @class */ function() {
    function t(
    /**
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    return t.prototype.Pe = function(t) {
        for (var e = 0, n = t.Zt; e < n.length; e++) {
            var r = n[e];
            t.te instanceof nn ? this.Ve(r, t.te) : t.te instanceof rn && this.pe(r, t.key, t.te);
        }
    ...
    t.prototype.Ce = function(t) {
        ...
        if (r) {
            ...
            if (Z$1(i)) if (0 === n) {
                ...
                // queries.
                var o = new W$1(i.path);
                this.pe(e, o, new rn(o, G$1.min()));
    ...
    t.prototype.Ne = function(t) {
        ...
        this.Ee.forEach((function(r, i) {
            ...
            if (o) {
                if (r.Ht && Z$1(o.target)) {
                    ...
                    var s = new W$1(o.target.path);
                    null !== e.Ie.get(s) || e.$e(i, s) || e.pe(i, s, new rn(s, t));
                }
        ...
        return this.Ie = pt(), this.Re = Pt(), this.Ae = new ht(R$1), i;
    }, 
    /**
    ...
    t.prototype.de = function(t) {
        ...
        var e = this.Ee.get(t);
        return e || (e = new Rt, this.Ee.set(t, e)), e;
    }, t.prototype.ke = function(t) {
        var e = this.Re.get(t);
        return e || (e = new ht(R$1), this.Re = this.Re.nt(t, e)), e;
    }, 
    /**
    ...
    t.prototype.Se = function(t) {
        var e = this;
        this.Ee.set(t, new Rt), this.me.xe(t).forEach((function(n) {
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function Mt(t, e) {
    ...
    switch (n) {
      ...
      case 9 /* ArrayValue */ :
        return O$1(t.arrayValue.values || [], e.arrayValue.values || [], Mt);
...
function xt(t, e) {
    var n = Ct(t), r = Ct(e);
    if (n !== r) return R$1(n, r);
    switch (n) {
      case 0 /* NullValue */ :
        return 0;

      case 1 /* BooleanValue */ :
        return R$1(t.booleanValue, e.booleanValue);
      ...
      case 5 /* StringValue */ :
        return R$1(t.stringValue, e.stringValue);
      ...
      case 7 /* RefValue */ :
        return function(t, e) {
            ...
            return R$1(n.length, r.length);
        }(t.referenceValue, e.referenceValue);

      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = R$1(Bt(t.latitude), Bt(e.latitude));
            return 0 !== n ? n : R$1(Bt(t.longitude), Bt(e.longitude));
...
function Gt(t, e) {
    if ("string" == typeof t && "string" == typeof e && t.length === e.length) return R$1(t, e);
    var n = zt(t), r = zt(e), i = R$1(n.seconds, r.seconds);
    return 0 !== i ? i : R$1(n.nanos, r.nanos);
}
...
function jt(t) {
    return function t(e) {
        ...
        W$1.U(r).toString()) : "geoPointValue" in e ? "geo(" + (n = e.geoPointValue).latitude + "," + n.longitude + ")" : "arrayValue" in e ? function(e) {
...
function he(t, e) {
    ...
    new W$1((_((n = r).length > 4 && "documents" === n.get(4)), n.p(5)));
}
...
function le(t) {
    return new z([ "projects", t.s.projectId, "databases", t.s.database ]).N();
}
 ...
 */ function Ie(t, e, n) {
    ...
    }(n, e) : t instanceof _e ? De(t, e) : t instanceof Ve ? ke(t, e) : function(t, e) {
        // PORTING NOTE: Since JavaScript's integer arithmetic is limited to 53 bit
        // precision and resolves overflows by reducing precision, we do not
        // manually cap overflows at 2^63.
        var n = Ae(t, e), r = Oe(n) + Oe(t.Me);
        return Qt(n) && Qt(t.Me) ? ee(r) : ne(t.serializer, r);
    }(t, e);
}
 ...
 */ function Ne(t, e, n) {
    ...
    // applications.
    return t instanceof _e ? De(t, e) : t instanceof Ve ? ke(t, e) : n;
}
 ...
 */ function Ae(t, e) {
    return t instanceof Re ? Qt(n = e) || function(t) {
...
/** Transforms an array value via a remove operation. */ var Ve = /** @class */ function(e) {
    function n(t) {
        var n = this;
        return (n = e.call(this) || this).elements = t, n;
    }
 ...
 */ var Le = /** @class */ function() {
    ...
    return t.prototype.Qe = function(t) {
        ...
        return O$1(this.fields, t.fields, (function(t, e) {
            return t.isEqual(e);
        }));
    }, t;
}(), Ue = function(t, e) {
 ...
 */ function Fe(t, e, n) {
    ...
    }(t, 0, n) : t instanceof Ke ? function(t, e, n) {
        if (!Ce(t.Be, e)) 
 ...
 */ function xe(t, e, n, r) {
    return t instanceof Be ? function(t, e) {
    ...
    }(t, e) : t instanceof Ke ? function(t, e) {
        if (!Ce(t.Be, e)) return e;
        var n = ze(e), r = We(t, e);
        ...
        return Ce(t.Be, e) ? new rn(t.key, G$1.min()) : e;
    }(t, e);
}
...
function je(t, e) {
    return t.type === e.type && !!t.key.isEqual(e.key) && !!t.Be.isEqual(e.Be) && (0 /* Set */ === t.type ? t.value.isEqual(e.value) : 1 /* Patch */ === t.type ? t.data.isEqual(e.data) && t.qe.isEqual(e.qe) : 2 /* Transform */ !== t.type || O$1(t.fieldTransforms, t.fieldTransforms, (function(t, e) {
        return function(t, e) {
            return t.field.isEqual(e.field) && function(t, e) {
                return t instanceof _e && e instanceof _e || t instanceof Ve && e instanceof Ve ? O$1(t.elements, e.elements, Mt) : t instanceof Re && e instanceof Re ? Mt(t.Me, e.Me) : t instanceof Te && e instanceof Te;
 ...
 */ function ze(t) {
    return t instanceof nn ? t.version : G$1.min();
}
...
/** A mutation that deletes the document at the given key. */ var $e = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).key = t, r.Be = n, r.type = 3 /* Delete */ , r;
    }
    return __extends(n, e), n;
}(Me), Xe = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
    ...
    /** Returns an ObjectValue with all mutations applied. */ t.prototype.ze = function() {
        var t = this.Xe(K$1.k(), this.He);
        return null != t ? new Je(t) : this.Ke;
    }, 
    /**
    ...
    t.prototype.Xe = function(t, e) {
        var n = this, r = !1, i = this.Ke.field(t), o = Xt(i) ? // If there is already data at the current path, base our
...
function tn(t) {
    var e = [];
    return S$1(t.fields || {}, (function(t, n) {
        var r = new K$1([ t ]);
        if (Xt(n)) {
 ...
 */ var un = /** @class */ function() {
     ...
     */    return t.prototype.rn = function(e) {
        ...
        return !Q$1(this.limit) && "F" /* First */ === this.en;
    }, t.prototype.an = function() {
        return !Q$1(this.limit) && "L" /* Last */ === this.en;
 ...
 */ function hn(t) {
    ...
    if (null === e.nn) {
        ...
        n.O() || e.nn.push(new Rn(n)), e.nn.push(new Rn(K$1.q(), "asc" /* ASCENDING */)); else {
 ...
 */ function fn(t) {
    var e = sn(t, un);
    if (!e.sn) if ("F" /* First */ === e.en) e.sn = $(e.path, e.collectionGroup, hn(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
        // Flip the orderBy directions since we want the last results
        var n = [], r = 0, i = hn(e); r < i.length; r++) {
            var o = i[r], s = "desc" /* DESCENDING */ === o.dir ? "asc" /* ASCENDING */ : "desc" /* DESCENDING */;
            n.push(new Rn(o.field, s));
        }
        ...
        // Now return as a LimitType.First query.
                e.sn = $(e.path, e.collectionGroup, n, e.filters, e.limit, u, a);
    }
    return e.sn;
}
...
function yn(t, e) {
    return J$1(fn(t), fn(e)) && t.en === e.en;
}
...
function gn(t) {
    return "Query(target=" + function(t) {
        ...
        Q$1(t.limit) || (e += ", limit: " + t.limit), t.orderBy.length > 0 && (e += ", orderBy: [" + t.orderBy.map((function(t) {
            return (e = t).field.N() + " (" + e.dir + ")";
            var e;
        })).join(", ") + "]"), t.startAt && (e += ", startAt: " + Dn(t.startAt)), t.endAt && (e += ", endAt: " + Dn(t.endAt)), 
        "Target(" + e + ")";
    }(fn(t)) + "; limitType=" + t.en + ")";
}
...
/** Returns whether `doc` matches the constraints of `query`. */ function mn(t, e) {
    return function(t, e) {
        var n = e.key.path;
        return null !== t.collectionGroup ? e.key.B(t.collectionGroup) && t.path.C(n) : W$1.W(t.path) ? t.path.isEqual(n) : t.path.D(n);
    }(t, e) && function(t, e) {
        ...
        return !(t.startAt && !Vn(t.startAt, hn(t), e)) && (!t.endAt || !Vn(t.endAt, hn(t), e));
    }(t, e);
}
...
var bn = /** @class */ function(e) {
     ...
     */    return __extends(n, e), n.create = function(t, e, r) {
        if (t.O()) return "in" /* IN */ === e ? new In(t, r) : new En(t, e, r);
        if (Ht(r)) {
            if ("==" /* EQUAL */ !== e) throw new F$1(M$1.INVALID_ARGUMENT, "Invalid query. Null supports only equality comparisons.");
            return new n(t, e, r);
        }
        if ($t(r)) {
            if ("==" /* EQUAL */ !== e) throw new F$1(M$1.INVALID_ARGUMENT, "Invalid query. NaN supports only equality comparisons.");
            return new n(t, e, r);
        }
        return "array-contains" /* ARRAY_CONTAINS */ === e ? new Nn(t, r) : "in" /* IN */ === e ? new An(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new Tn(t, r) : new n(t, e, r);
    }, n.prototype.matches = function(t) {
        var e = t.field(this.field);
        // Only compare types with matching backend order (such as double and int).
                return null !== e && Ct(this.value) === Ct(e) && this.fn(xt(e, this.value));
...
var En = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this, t, n, r) || this).key = W$1.U(r.referenceValue), i;
    }
    return __extends(n, e), n.prototype.matches = function(t) {
        var e = W$1.P(t.key, this.key);
        return this.fn(e);
    }, n;
...
/** Filter that matches on key fields within an array. */ function Dn(t) {
 ...
 */ function Vn(t, e, n) {
    for (var r = 0, i = 0; i < t.position.length; i++) {
        ...
        if (r = o.field.O() ? W$1.P(W$1.U(s.referenceValue), n.key) : xt(s, n.field(o.field)), 
 ...
 */ var Rn = function(t, e /* ASCENDING */) {
    void 0 === e && (e = "asc"), this.field = t, this.dir = e;
};

function On(t, e, n) {
    var r = t.field.O() ? W$1.P(e.key, n.key) : function(t, e, n) {
 ...
 */ var Ln = /** @class */ function() {
    ...
    t.prototype.En = function(t) {
        ...
        return this.batchId === t.batchId && O$1(this.mutations, t.mutations, (function(t, e) {
            return je(t, e);
        })) && O$1(this.baseMutations, t.baseMutations, (function(t, e) {
            return je(t, e);
        }));
    }, t;
}(), Un = /** @class */ function() {
    ...
    return t.prototype.catch = function(t) {
        ...
        var r = this;
        return this.pn && T$1(), this.pn = !0, this.Vn ? this.error ? this.yn(n, this.error) : this.gn(e, this.result) : new t((function(t, i) {
            r.An = function(n) {
                r.gn(e, n).next(t, i);
            }, r.Pn = function(e) {
                r.yn(n, e).next(t, i);
    ...
    return t.prototype.$n = function(t, e) {
        var n = this;
    ...
    t.prototype.Mn = function(t, e) {
        ...
        return this.Fn.Un(t, e).next((function(r) {
            ...
            return i.forEach((function(t, e) {
                ...
                e || (e = new rn(t, G$1.min())), o = o.nt(t, e);
            })), o;
        }));
    }, 
    /**
 ...
 */
        return function(t) {
            return W$1.W(t.path) && null === t.collectionGroup && 0 === t.filters.length;
        }(e) ? this.Wn(t, e.path) : cn(e) ? this.Qn(t, e, n) : this.jn(t, e, n);
    }, t.prototype.Wn = function(t, e) {
        // Just do a simple document lookup.
        return this.$n(t, new W$1(e)).next((function(t) {
            var e = vt();
            return t instanceof nn && (e = e.nt(t.key, t)), e;
        }));
    }, t.prototype.Qn = function(t, e, n) {
        var r = this, i = e.collectionGroup, o = vt();
        return this.Nn.Gn(t, i).next((function(s) {
            return Sn.forEach(s, (function(s) {
...
/** The result of applying a mutation batch to the backend. */ Mn.ns = -1;
...
var Fn = function() {
    ...
    t.prototype.fs = function(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                i > 0 && E$1("ExponentialBackoff", "Backing off for " + i + " ms (base delay: " + this.us + " ms, delay with jitter: " + n + " ms, last attempt: " + r + " ms ago)"), 
    ...
    return t.prototype.Is = function(t, e) {
        return this.Es.add(e), Sn.resolve();
    }, t.prototype.Gn = function(t, e) {
        return Sn.resolve(this.Es.getEntries(e));
    }, t;
}(), jn = /** @class */ function() {
    function t() {
        this.index = {};
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.S(), n = t.g(), r = this.index[e] || new ht(z.P), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.S(), n = t.g(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new ht(z.P)).F();
    }, t;
}(), zn = /** @class */ function() {
    function t(t) {
        this.Rs = t;
 ...
 * limitations under the License.
 */
/** Verifies whether `e` is an IndexedDbTransactionError. */ function Bn(t) {
 ...
 * limitations under the License.
 */
/** The Platform's 'window' implementation or null if not available. */ function Kn() {
 ...
 */ var Wn = /** @class */ function() {
    function t(t, e, n, r, i) {
        this.Vs = t, this.rs = e, this.ps = n, this.op = r, this.ys = i, this.gs = new Fn, 
    ...
    t.prototype.cancel = function(t) {
        null !== this.bs && (this.clearTimeout(), this.gs.reject(new F$1(M$1.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    ...
    function t() {
        ...
        this.Os = new xn(this, "async_queue_retry" /* AsyncQueueRetry */), 
    ...
    t.prototype.js = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.Bs(), this.Ns ? [ 3 /*break*/ , 2 ] : (this.Ns = !0, (e = Kn()) && e.removeEventListener("visibilitychange", this.qs), 
                    [ 4 /*yield*/ , this.Qs(t) ]);
    ...
    t.prototype.enqueue = function(t) {
        return this.Bs(), this.Ns ? new Promise((function(t) {})) : this.Ws(t);
    }, 
    /**
    ...
    t.prototype.zs = function() {
        ...
        var e = this, n = this.Ds.then((function() {
            return e.xs = !0, t().catch((function(t) {
                ...
                throw e.ks = t, e.xs = !1, I$1("INTERNAL UNHANDLED ERROR: ", 
                /**
 ...
 */
    ...
    t.prototype.ws = function(t, e, n) {
        ...
        var i = Wn.vs(this, t, e, n, (function(t) {
            return r.Ks(t);
        }));
    ...
    t.prototype.Xs = function(t) {
        for (var e = 0, n = this.$s; e < n.length; e++) {
    ...
    t.prototype.Js = function(t) {
        ...
        // Note that draining may generate more delayed ops, so we do that first.
            ...
            for (var n = 0, r = e.$s; n < r.length; n++) {
                var i = r[n];
 ...
 */
function Yn(t, e) {
    if (I$1("AsyncQueue", e + ": " + t), Bn(t)) return new F$1(M$1.UNAVAILABLE, e + ": " + t);
    throw t;
}
...
Hn.oi = -1, Hn.hi = 1048576, Hn.ai = 41943040, Hn.ii = 10, Hn.ri = 1e3, Hn.ui = new Hn(Hn.ai, Hn.ii, Hn.ri), 
Hn.ci = new Hn(Hn.oi, 0, 0);
...
var $n = /** @class */ function() {
    ...
    t, e, n) {
        ...
        /**
             ...
             */
        this.di = G$1.min(), this.Fn = t.wi(n), this.Ti = t.mi(), this.Ei = t.Ii(), this.Ri = new qn(this.Ti, this.Fn, this.persistence.Ai()), 
        this.li.Pi(this.Ri);
    }
    return t.prototype.Vi = function(t) {
                  ...
                  case 0:
                    return e = this.Fn, r = this.Ri, [ 4 /*yield*/ , this.persistence.runTransaction("Handle user change", "readonly", (function(n) {
                        ...
                        return o.Fn.pi(n).next((function(s) {
                            ...
                            // MutationQueue.
                            r = new qn(o.Ti, e, o.persistence.Ai()), e.pi(n);
                        })).next((function(t) {
        ...
        var e, n = this, r = x$1.now(), i = t.reduce((function(t, e) {
            return t.add(e.key);
        }), wt());
        return this.persistence.runTransaction("Locally write mutations", "readwrite", (function(o) {
            return n.Ri.qn(o, i).next((function(i) {
                ...
                var s = [], u = 0, a = t; u < a.length; u++) {
                    var c = a[u], h = Ge(c, e.get(c.key));
                    null != h && 
                    // NOTE: The base state should only be applied if there's some
                    // existing document to override, so use a Precondition of
                    // exists=true
                    s.push(new Ke(c.key, h, tn(h.proto.mapValue), qe.exists(!0)));
                }
        ...
        return this.persistence.runTransaction("Reject batch", "readwrite-primary", (function(n) {
            ...
            return e.Fn.Li(n, t).next((function(t) {
                return _(null !== t), r = t.keys(), e.Fn.Oi(n, t);
            })).next((function() {
                return e.Fn.ki(n);
            })).next((function() {
                return e.Ri.qn(n, r);
        ...
        return this.persistence.runTransaction("Apply remote event", "readwrite-primary", (function(o) {
            ...
            u.push(s.getEntries(o, c).next((function(t) {
                e.jt.forEach((function(i, c) {
                    ...
                    // cache.
                                        c instanceof rn && c.version.isEqual(G$1.min()) ? (
                    ...
                    a = a.nt(i, c)) : E$1("LocalStore", "Ignoring outdated watch update for ", i, ". Current version:", h.version, " Watch version:", c.version), 
    ...
    t.ji = function(t, e, n) {
                ...
                switch (n.label) {
                  case 0:
                    return n.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , this.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(e) {
                        return Sn.forEach(t, (function(t) {
                            return Sn.forEach(t.Hn, (function(n) {
                                return h.persistence.Yi.tr(e, t.targetId, n);
                            })).next((function() {
                                return Sn.forEach(t.Yn, (function(n) {
                  ...
                  case 2:
                    if (!Bn(e = n.sent())) throw e;
                    // If `notifyLocalViewChanges` fails, we did not advance the sequence
                    // number for the documents that were included in this transaction.
                    // This might trigger them to be deleted earlier than they otherwise
                    // would have, but it should not invalidate the integrity of the data.
                                        return E$1("LocalStore", "Failed to update sequence numbers: " + e), 
                    [ 3 /*break*/ , 3 ];
        ...
        return this.persistence.runTransaction("Allocate target", "readwrite", (function(n) {
            ...
            return e.Ei.or(n, t).next((function(i) {
                ...
                r = i, Sn.resolve(r)) : e.Ei.hr(n).next((function(i) {
        ...
        var n = this.fi.get(e);
        return void 0 !== n ? Sn.resolve(this._i.get(n)) : this.Ei.or(t, e);
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  ...
                  case 4:
                    if (!Bn(o = n.sent())) throw o;
                    // All `releaseTarget` does is record the final metadata state for the
                    // target, but we've been recording this periodically during target
                    // activity. If we lose this write this could cause a very slight
                    // difference in the order of target deletion during GC, but we
                    // don't define exact LRU semantics so this is acceptable.
                                        return E$1("LocalStore", "Failed to update sequence numbers for target " + t + ": " + o), 
                    [ 3 /*break*/ , 5 ];
        ...
        return this.persistence.runTransaction("Execute query", "readonly", (function(o) {
            return n.or(o, fn(t)).next((function(t) {
                ...
                return n.li.Bn(o, t, e ? r : G$1.min(), e ? i : wt());
            })).next((function(t) {
                return {
                    documents: t,
                    _r: i
        ...
        var r = this, i = e.batch, o = i.keys(), s = Sn.resolve();
...
var Jn = /** @class */ function() {
    function t() {
        ...
        this.Tr = new ht(Zn.mr), 
        // A set of outstanding references to a document sorted by target id.
        this.Er = new ht(Zn.Ir)
    ...
    t.prototype.Vr = function(t) {
        var e = this, n = new W$1(new z([])), r = new Zn(n, t), i = new Zn(n, t + 1), o = [];
        ...
        var e = new W$1(new z([])), n = new Zn(e, t), r = new Zn(e, t + 1), i = wt();
    ...
    return t.mr = function(t, e) {
        return W$1.P(t.key, e.key) || R$1(t.vr, e.vr);
    }, 
    /** Compare by ID then by key */ t.Ir = function(t, e) {
        return R$1(t.vr, e.vr) || W$1.P(t.key, e.key);
    }, t;
}(), tr = /** @class */ function() {
    function t(t) {
        this.uid = t;
...
/** A user with a null UID. */ tr.UNAUTHENTICATED = new tr(null), 
// TODO(mikelehen): Look into getting a proper uid-equivalent for
// non-FirebaseAuth providers.
tr.Cr = new tr("google-credentials-uid"), tr.Dr = new tr("first-party-uid");
...
var er = function(t, e) {
    ...
    function t(t) {
        ...
        this.currentUser = tr.UNAUTHENTICATED, this.Or = !1, 
        /**
        ...
        this.Nr = null, this.forceRefresh = !1, this.Lr = function() {
            e.qr++, e.currentUser = e.Mr(), e.Or = !0, e.Nr && e.Nr(e.currentUser);
    ...
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            return t.qr !== e ? (E$1("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
            t.getToken()) : n ? (_("string" == typeof n.accessToken), new er(n.accessToken, t.currentUser)) : null;
    ...
    t.prototype.Mr = function() {
        ...
        return _(null === t || "string" == typeof t), new tr(t);
    }, t;
}(), ir = /** @class */ function() {
    function t(t, e) {
        this.Ur = t, this.Br = e, this.type = "FirstParty", this.user = tr.Dr;
    }
    ...
    return t.prototype.getToken = function() {
        return Promise.resolve(new ir(this.Ur, this.Br));
    }, t.prototype.kr = function(t) {
    ...
    function t(t, e, n, r, i, o) {
        ...
        /**
             ...
             * close.
             */
        this.zr = 0, this.Kr = null, this.stream = null, this.Os = new xn(t, e)
        /**
    ...
    t.prototype.ro = function(t) {
        ...
        return function(n) {
            e.ss.Cs((function() {
                return e.zr === t ? n() : (E$1("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, t;
    ...
    return __extends(n, e), n.prototype.ao = function(t) {
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                y.document;
                var v = he(t, y.document), g = y.readTime ? ue(y.readTime) : G$1.min(), m = new rn(v, g), w = y.removedTargetIds || [];
                n = new Dt([], w, m.key, m);
                ...
                var N = e.filter;
                N.targetId;
                var A = N.count || 0, D = new it(A), V = N.targetId;
                n = new Vt(V, D);
            }
            return n;
            ...
            if (!("targetChange" in t)) return G$1.min();
            var e = t.targetChange;
            return e.targetIds && e.targetIds.length ? G$1.min() : e.readTime ? ue(e.readTime) : G$1.min();
        }(t);
    ...
    return __extends(i, r), i.prototype.Ao = function() {
        if (this.Ro) throw new F$1(M$1.FAILED_PRECONDITION, "The client has already been terminated.");
    ...
    /** Gets an auth token and invokes the provided RPC. */ i.prototype.Po = function(t, e, n) {
        ...
        return this.Ao(), this.credentials.getToken().then((function(i) {
            ...
            throw t.code === M$1.UNAUTHENTICATED && r.credentials.$r(), t;
        }));
    }, 
    ...
    t.prototype.No = function(t) {
        ...
        this.vo >= 1 && (this.$o(), this.Fo("Connection failed 1 times. Most recent error: " + t.toString()), 
    ...
    t.prototype.set = function(t) {
        this.$o(), this.vo = 0, "Online" /* Online */ === t && (
        ...
        this.So ? (I$1(e), this.So = !1) : E$1("OnlineStateTracker", e);
    ...
    r, i, o, s) {
            ...
            i.Cs((function() {
                return __awaiter(u, void 0, void 0, (function() {
                    return __generator(this, (function(t) {
                        switch (t.label) {
                          case 0:
                            return this.Wo() ? (E$1("RemoteStore", "Restarting streams for network reachability change."), 
        ...
        this.Go = function(t, e, n) {
            var r = D$1(t);
            return r.Ao(), new ur(e, r.jr, r.credentials, r.serializer, n);
        }(this.xo, i, {
    ...
    t.prototype.disableNetwork = function() {
        ...
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(t) {
                switch (t.label) {
                  ...
                  case 2:
                    return t.sent(), this.Lo.length > 0 && (E$1("RemoteStore", "Stopping write stream with " + this.Lo.length + " pending writes"), 
        ...
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return E$1("RemoteStore", "RemoteStore shutting down."), this.Mo.add(5 /* Shutdown */), 
                    [ 4 /*yield*/ , this.ih() ];
    ...
    t.prototype.uh = function(t) {
        ...
        this.qo = new Ot(this), this.Go.start(), this.jo.Co();
    }, 
    /**
    ...
    t.prototype.eh = function() {
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (this.jo.set("Online" /* Online */), !(t instanceof kt && 2 /* Removed */ === t.state && t.cause)) 
                  ...
                  case 6:
                    if (t instanceof Dt ? this.qo.Pe(t) : t instanceof Vt ? this.qo.Ce(t) : this.qo.ye(t), 
                    r.isEqual(G$1.min())) return [ 3 /*break*/ , 13 ];
                    n.label = 7;
                  ...
                  case 11:
                    return E$1("RemoteStore", "Failed to raise snapshot:", o = n.sent()), [ 4 /*yield*/ , this.fh(o) ];
    ...
    t.prototype.Eh = function(t) {
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return e = this.Lo.shift(), i = Un.from(e, t, r), [ 4 /*yield*/ , this.wh((function() {
                        return o.lh.Ph(i);
                    })) ];
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return ot(r = t.code) && r !== M$1.ABORTED ? (e = this.Lo.shift(), 
            ...
            return __generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    E$1("RemoteStore", "RemoteStore received new credentials"), this.Mo.add(3 /* CredentialChange */), 
                    [ 4 /*yield*/ , this.ih() ];
    ...
    function t() {
        this.Ch = new lr, this.Dh = {}, this.yo = null, this.Jn = null;
    }
    return t.prototype.Fh = function(t) {
        ...
        return this.Ch = new lr, Promise.resolve();
    ...
    e) {
        ...
        this.qt = wt(), this.jh = wn(t), this.Gh = new It(this.jh);
    }
    ...
    t.prototype.Kh = function(t, e) {
        var n = this, r = e ? e.Hh : new Nt, i = e ? e.Gh : this.Gh, o = e ? e.qt : this.qt, s = i, u = !1, a = this.query.hn() && i.size === this.query.limit ? i.last() : null, c = this.query.an() && i.size === this.query.limit ? i.first() : null;
    ...
    t.prototype.Jh = function(t, e, n) {
        ...
        return this.Wh = u, 0 !== o.length || a ? {
            snapshot: new At(this.query, t.Gh, i, o, t.qt, 0 /* Local */ === u, a, 
            /* excludesMetadataChanges= */ !1),
            ea: s
        } : {
            ea: s
    ...
    t.prototype.Zh = function(t) {
        ...
        // updating many documents.
                var e = this.Qh;
        this.Qh = wt(), this.Gh.forEach((function(e) {
            t.sa(e.key) && (t.Qh = t.Qh.add(e.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        var n = [];
        return e.forEach((function(e) {
            t.Qh.has(e) || n.push(new yr(e));
        })), this.Qh.forEach((function(t) {
            e.has(t) || n.push(new dr(t));
        })), n;
    }, 
    /**
    ...
    t.prototype.ra = function() {
        return At.Bt(this.query, this.Gh, this.qt, 0 /* Local */ === this.Wh);
    }, t;
}(), gr = function(
/**
     * The query itself.
...
n) {
    ...
    r, i, o) {
        ...
        this.ca = null, this.la = new C$1((function(t) {
            return vn(t);
        }), yn), this._a = new Map, 
        /**
        ...
        /**
             ...
             * active target.
             */
        this.da = new ut(W$1.P), 
        /**
             * Keeps track of the information about an active limbo resolution for each
             * active target ID that was started for the purpose of limbo resolution.
             */
        this.wa = new Map, this.Ta = new Jn, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.ma = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.Ea = new Map, this.Ia = zn.Ps(), this.onlineState = "Unknown" /* Unknown */ , 
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    e = i.targetId, this.aa.$h(e), r = i.view.ra(), [ 3 /*break*/ , 4 ]) : [ 3 /*break*/ , 1 ];

                  case 1:
                    return [ 4 /*yield*/ , this.ko.rr(fn(t)) ];

                  case 2:
                    return o = n.sent(), s = this.aa.$h(o.targetId), e = o.targetId, [ 4 /*yield*/ , this.Va(t, e, "current" === s) ];
    ...
    t.prototype.Va = function(t, r, i) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return e = n.sent(), o = new vr(t, e._r), s = o.Kh(e.documents), u = _t.Kt(r, i && "Offline" /* Offline */ !== this.onlineState), 
                    a = o.Jh(s, 
                    /* updateLimboDocuments= */ this.Aa, u), this.pa(r, a.ea), c = new gr(t, r, o), 
                ...
                switch (n.label) {
                  ...
                  case 2:
                    ...
                    t.Wt.forEach((function(t, e) {
                        ...
                        _(t.Yt.size + t.Xt.size + t.Jt.size <= 1), t.Yt.size > 0 ? n.oa = !0 : t.Xt.size > 0 ? _(n.oa) : t.Jt.size > 0 && (_(n.oa), 
                        n.oa = !1));
                    })), [ 4 /*yield*/ , this.va(e, t) ];
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    // PORTING NOTE: Multi-tab only.
                    this.aa.kh(t, "rejected", r), e = this.wa.get(t), (i = e && e.key) ? (o = (o = new ut(W$1.P)).nt(i, new rn(i, G$1.min())), 
                    s = wt().add(i), u = new Tt(G$1.min(), 
                    /* targetChanges= */ new Map, 
                    /* targetMismatches= */ new ht(R$1), o, s), [ 4 /*yield*/ , this.Ui(u) ]) : [ 3 /*break*/ , 2 ];
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  ...
                  case 2:
                    ...
                    this.Ca(e, /*error=*/ null), this.Da(e), this.aa.Nh(e, "acknowledged"), [ 4 /*yield*/ , this.va(r) ];
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  ...
                  case 2:
                    ...
                    // listen events.
                    this.Ca(t, r), this.Da(t), this.aa.Nh(t, "rejected", r), [ 4 /*yield*/ , this.va(e) ];
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    this.ha.Wo() || E$1("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                    n.label = 1;
    ...
    /** Reject all outstanding callbacks waiting for pending writes to complete. */ t.prototype.Na = function(t) {
        ...
        n || (n = new ut(R$1)), n = n.nt(t, e), this.ma[this.currentUser.Sr()] = n;
    }, 
    /**
    ...
    t.prototype.Ca = function(t, e) {
        ...
        for (var r = 0, i = this._a.get(t); r < i.length; r++) {
            var o = i[r];
            this.la.delete(o), e && this.ca.$a(o, e);
        }
        ...
        for (var n = 0, r = e; n < r.length; n++) {
            var i = r[n];
            i instanceof dr ? (this.Ta.tr(i.key, t), this.xa(i)) : i instanceof yr ? (E$1("SyncEngine", "Document no longer in limbo: " + i.key), 
        ...
        var e = t.key;
        this.da.get(e) || (E$1("SyncEngine", "New document in limbo: " + e), this.fa.push(e), 
        this.Sa());
    }, 
    /**
    ...
    t.prototype.Sa = function() {
        for (;this.fa.length > 0 && this.da.size < this.ua; ) {
            ...
            this.wa.set(e, new mr(t)), this.da = this.da.nt(t, e), this.ha.listen(new rt(fn(an(t.path)), e, 2 /* LimboResolution */ , Mn.ns));
        }
    }, 
    // Visible for testing
    ...
    t.prototype.Oa = function() {
                    ...
                    return e = [], i = [], o = [], this.la.forEach((function(n, u) {
                        o.push(Promise.resolve().then((function() {
                            ...
                            if (s.pa(u.targetId, o.ea), o.snapshot) {
                                ...
                                var a = Cn.Xn(u.targetId, o.snapshot);
                                i.push(a);
                            }
                        })));
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.currentUser.isEqual(t) ? [ 3 /*break*/ , 3 ] : (E$1("SyncEngine", "User change. New user:", t.Sr()), 
                    [ 4 /*yield*/ , this.ko.Vi(t) ]);

                  case 1:
                    return e = n.sent(), this.currentUser = t, 
                    // Fails tasks waiting for pending writes requested by previous user.
                    this.Na("'waitForPendingWrites' promise is rejected due to a user change."), 
        ...
        var e = this.wa.get(t);
        if (e && e.oa) return wt().add(e.key);
        var n = wt(), r = this._a.get(t);
        if (!r) return n;
    ...
    function t(t) {
        this.lh = t, this.Ma = new C$1((function(t) {
            return vn(t);
        }), yn), this.onlineState = "Unknown" /* Unknown */ , this.Ua = new Set, this.lh.subscribe(this);
    }
    return t.prototype.listen = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (e = t.query, r = !1, (i = this.Ma.get(e)) || (r = !0, i = new br), !r) return [ 3 /*break*/ , 4 ];
                    n.label = 1;
    ...
    return t.prototype.Ba = function(t) {
        if (!this.options.includeMetadataChanges) {
            ...
            t = new At(t.query, t.docs, t.Ot, e, t.qt, t.fromCache, t.Mt, 
    ...
    /** Returns whether a snapshot was raised. */ t.prototype.na = function(t) {
        ...
        t = At.Bt(t.query, t.docs, t.qt, t.fromCache), this.za = !0, this.Ga.next(t);
    }, t;
}(), Nr = /** @class */ function() {
    function t() {}
    return t.prototype.Pi = function(t) {
        ...
        // collection, rather than to perform individual lookups.
                return e.on() || n.isEqual(G$1.min()) ? this.tu(t, e) : this.Za.qn(t, r).next((function(o) {
            var u = i.eu(e, o);
            return (e.hn() || e.an()) && i.Xh(e.en, u, r, n) ? i.tu(t, e) : (b() <= LogLevel.DEBUG && E$1("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), gn(e)), 
    ...
    function t(t, e) {
        ...
        this.su = new ht(Zn.mr);
    }
    return t.prototype.iu = function(t) {
        return Sn.resolve(0 === this.Fn.length);
    }, t.prototype.Si = function(t, e, n, r) {
        var i = this.nu;
        this.nu++, this.Fn.length > 0 && this.Fn[this.Fn.length - 1];
        var o = new Ln(i, e, n, r);
        this.Fn.push(o);
        // Track references by document key and index collection parents.
        for (var s = 0, u = r; s < u.length; s++) {
            var a = u[s];
            this.su = this.su.add(new Zn(a.key, i)), this.Nn.Is(t, a.key.path.g());
        }
        return Sn.resolve(o);
    }, t.prototype.Li = function(t, e) {
        return Sn.resolve(this.ru(e));
    }, t.prototype.sr = function(t, e) {
        var n = e + 1, r = this.ou(n), i = r < 0 ? 0 : r;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return Sn.resolve(this.Fn.length > i ? this.Fn[i] : null);
    }, t.prototype.qi = function() {
        return Sn.resolve(0 === this.Fn.length ? -1 : this.nu - 1);
    }, t.prototype.pi = function(t) {
        return Sn.resolve(this.Fn.slice());
        ...
        // because it precedes all other segments in an ordered traversal.
                W$1.W(i) || (i = i.child(""));
        var o = new Zn(new W$1(i), 0), s = new ht(R$1);
        ...
        var n = this;
        _(0 === this.au(e.batchId, "removed")), this.Fn.shift();
        var r = this.su;
        return Sn.forEach(e.mutations, (function(i) {
        ...
        return Sn.resolve(e.isEqual(r && r.key));
    }, t.prototype.ki = function(t) {
        return this.Fn.length, Sn.resolve();
    }, 
    /**
    ...
    return t.prototype.Ki = function(t, e, n) {
        ...
        return this.docs = this.docs.nt(r, {
            ...
            size: s,
            readTime: n
        }), this.size += s - o, this.Nn.Is(t, r.path.g());
    }, 
    /**
    ...
    t.prototype.zi = function(t) {
        ...
        for (var r = vt(), i = new W$1(e.path.child("")), o = this.docs.ut(i)
        ...
        return Sn.forEach(this.docs, (function(t) {
            return e(t);
        }));
...
Tr.du = /** @class */ function(e) {
    ...
    t.prototype.Ln = function(t, e) {
        this.Eu();
        var n = this.Ci.get(e);
        return void 0 !== n ? Sn.resolve(n) : this.Iu(t, e);
    }, 
    /**
...
var _r = /** @class */ function() {
    function t(t) {
        ...
        /**
             ...
             */
        this.Pu = new C$1((function(t) {
            return X$1(t);
        }), J$1), 
        /** The last received snapshot version. */
        this.lastRemoteSnapshotVersion = G$1.min(), 
        ...
        /**
             ...
             * IDs.
             */
        this.pu = new Jn, this.targetCount = 0, this.yu = zn.As();
    }
    return t.prototype.ge = function(t, e) {
        ...
        return Sn.resolve(this.lastRemoteSnapshotVersion);
    }, t.prototype.gu = function(t) {
        return Sn.resolve(this.Vu);
    }, t.prototype.hr = function(t) {
        return this.highestTargetId = this.yu.next(), Sn.resolve(this.highestTargetId);
        ...
        var e = t.targetId;
        e > this.highestTargetId && (this.yu = new zn(e), this.highestTargetId = e), t.sequenceNumber > this.Vu && (this.Vu = t.sequenceNumber);
    }, t.prototype.ar = function(t, e) {
        return this.vu(e), this.targetCount += 1, Sn.resolve();
    }, t.prototype.Gi = function(t, e) {
        return this.vu(e), Sn.resolve();
        ...
        return this.Pu.forEach((function(s, u) {
            ...
            i++);
        })), Sn.Sn(o).next((function() {
            return i;
        }));
    }, t.prototype.Du = function(t) {
        return Sn.resolve(this.targetCount);
    }, t.prototype.or = function(t, e) {
        var n = this.Pu.get(e) || null;
        return Sn.resolve(n);
    }, t.prototype.Wi = function(t, e, n) {
        return this.pu.Rr(e, n), Sn.resolve();
        ...
        return this.pu.Vr(e), Sn.resolve();
    }, t.prototype.lr = function(t, e) {
        var n = this.pu.yr(e);
        return Sn.resolve(n);
    }, t.prototype.gr = function(t, e) {
        return Sn.resolve(this.pu.gr(e));
    }, t;
}(), Dr = /** @class */ function() {
    /**
    ...
    function t(t) {
        var e = this;
        this.Fu = {}, this.Nu = new Mn(0), this.$u = !1, this.$u = !0, this.Yi = t(this), 
        this.Ei = new _r(this), this.Nn = new Gn, this.Dn = new Tr(this.Nn, (function(t) {
            return e.Yi.ku(t);
        }));
    }
    return t.prototype.start = function() {
        ...
        var e = this.Fu[t.Sr()];
        return e || (e = new Ar(this.Nn, this.Yi), this.Fu[t.Sr()] = e), e;
        ...
        return Sn.Cn(Object.values(this.Fu).map((function(n) {
            return function() {
                return n.gr(t, e);
            };
        })));
    ...
    return t.zu = function(e) {
        ...
        return this.ju.tr(n, e), this.Ku.delete(n), Sn.resolve();
    }, t.prototype.er = function(t, e, n) {
        return this.ju.er(n, e), this.Ku.add(n), Sn.resolve();
    }, t.prototype.uu = function(t, e) {
        return this.Ku.add(e), Sn.resolve();
        ...
        // Remove newly orphaned documents.
                return Sn.forEach(this.Ku, (function(r) {
        ...
        var n = this;
        return Sn.Cn([ function() {
            return Sn.resolve(n.ju.gr(e));
        }, function() {
    ...
    return __extends(n, e), n.prototype.uc = function(t, e, n, r) {
        ...
        var s = r.createWebChannel(o, i), p = !1, d = !1, y = new Rr({
            Yu: function(t) {
        ...
        return m(esm_4.EventType.OPEN, (function() {
            ...
            d || (d = !0, E$1("Connection", "WebChannel transport closed"), y.nc());
        })), m(esm_4.EventType.ERROR, (function(t) {
            d || (d = !0, N$1("Connection", "WebChannel transport errored:", t), y.nc(new F$1(M$1.UNAVAILABLE, "The operation could not be completed")));
            ...
            if (!d) {
                ...
                if (i) {
                    ...
                    d = !0, y.nc(new F$1(u, a)), s.close();
                } else E$1("Connection", "WebChannel received:", n), y.sc(n);
            }
        })), setTimeout((function() {
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ var qr = "You are using the memory-only build of Firestore. Persistence support is only available via the @firebase/firestore bundle or the firebase-firestore.js build.", Cr = /** @class */ function() {
    function t() {}
    return t.prototype.initialize = function(t) {
        ...
        /** Manages our in-memory or durable persistence. */
        return e = this.persistence, n = new Nr, r = t.Pc, new $n(e, n, r);
        var e, n, r;
    }, t.prototype.Ec = function(t) {
        if (t.pc.Vc) throw new F$1(M$1.FAILED_PRECONDITION, qr);
        return new Dr(kr.zu);
        ...
        throw new F$1(M$1.FAILED_PRECONDITION, qr);
    }, t;
}(), Mr = /** @class */ function() {
    function t() {}
    return t.prototype.initialize = function(t, r) {
        ...
        var e = this;
        return new fr(this.ko, this.xo, t.Vs, (function(t) {
 ...
 */ function Gr(t, e) {
    if (0 !== e.length) throw new F$1(M$1.INVALID_ARGUMENT, "Function " + t + "() does not support arguments, but was called with " + oi(e.length, "argument") + ".");
}
 ...
 */ function jr(t, e, n) {
    if (e.length !== n) throw new F$1(M$1.INVALID_ARGUMENT, "Function " + t + "() requires " + oi(n, "argument") + ", but was called with " + oi(e.length, "argument") + ".");
}
 ...
 */ function zr(t, e, n) {
    if (e.length < n) throw new F$1(M$1.INVALID_ARGUMENT, "Function " + t + "() requires at least " + oi(n, "argument") + ", but was called with " + oi(e.length, "argument") + ".");
}
 ...
 */ function Br(t, e, n, r) {
    if (e.length < n || e.length > r) throw new F$1(M$1.INVALID_ARGUMENT, "Function " + t + "() requires between " + n + " and " + r + " arguments, but was called with " + oi(e.length, "argument") + ".");
}
 ...
 */ function $r(t, e, n, r) {
    if (!e.some((function(t) {
        return t === r;
    }))) throw new F$1(M$1.INVALID_ARGUMENT, "Invalid value " + Zr(r) + " provided to function " + t + "() for its " + ii(n) + " argument. Acceptable values: " + e.join(", "));
    return r;
}

/** Helper to validate the type of a provided input. */ function Xr(t, e, n, r) {
    if (!("object" === e ? Jr(r) : "non-empty string" === e ? "string" == typeof r && "" !== r : typeof r === e)) {
        var i = Zr(r);
...
function ti(t, e, n) {
    if (void 0 === n) throw new F$1(M$1.INVALID_ARGUMENT, "Function " + t + "() requires a valid " + ii(e) + " argument, but it was undefined.");
}
 ...
 */ function ni(t, e, n, r) {
    var i = Zr(r);
    return new F$1(M$1.INVALID_ARGUMENT, "Function " + t + "() requires its " + ii(n) + " argument to be a " + e + ", but it was: " + i);
}

function ri(t, e, n) {
    if (n <= 0) throw new F$1(M$1.INVALID_ARGUMENT, "Function " + t + "() requires its " + ii(e) + " argument to be a positive number, but it was: " + n + ".");
}

/** Converts a number to its english word representation */ function ii(t) {
    switch (t) {
      case 1:
        return "first";
 ...
 * limitations under the License.
 */
/** Helper function to assert Uint8Array is available at runtime. */ function si() {
    if ("undefined" == typeof Uint8Array) throw new F$1(M$1.UNIMPLEMENTED, "Uint8Arrays are not available in this environment.");
}

/** Helper function to assert Base64 functions are available at runtime. */ function ui() {
 ...
 */ var ai = /** @class */ function() {
    ...
    return t.fromBase64String = function(e) {
        jr("Blob.fromBase64String", arguments, 1), Kr("Blob.fromBase64String", "string", 1, e), 
        ui();
        try {
        ...
        if (jr("Blob.fromUint8Array", arguments, 1), si(), !(e instanceof Uint8Array)) throw ni("Blob.fromUint8Array", "Uint8Array", 1, e);
        return new t(tt.fromUint8Array(e));
    }, t.prototype.toBase64 = function() {
        return jr("Blob.toBase64", arguments, 0), ui(), this.Nc.toBase64();
    }, t.prototype.toUint8Array = function() {
        return jr("Blob.toUint8Array", arguments, 0), si(), this.Nc.toUint8Array();
    }, t.prototype.toString = function() {
    ...
    !function(t, e, n, r) {
        if (!(e instanceof Array) || e.length < 1) throw new F$1(M$1.INVALID_ARGUMENT, "Function FieldPath() requires its fieldNames argument to be an array with at least " + oi(1, "element") + ".");
    }(0, t);
    for (var e = 0; e < t.length; ++e) if (Kr("FieldPath", "string", e, t[e]), 0 === t[e].length) throw new F$1(M$1.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
    this.$c = new K$1(t);
}, hi = /** @class */ function(e) {
    /**
...
var yi = /** @class */ function(e) {
    ...
    return __extends(n, e), n.prototype.Lc = function(t) {
        return new Ue(t.path, new Te);
    }, n.prototype.isEqual = function(t) {
        return t instanceof n;
    }, n;
}(li), vi = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
    ...
    return __extends(n, e), n.prototype.Lc = function(t) {
        ...
        return new Ue(t.path, r);
    }, n.prototype.isEqual = function(t) {
        // TODO(mrschmidt): Implement isEquals
        return this === t;
    }, n;
}(li), gi = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).xc = t, r.Bc = n, r;
    }
...
}(li), mi = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).xc = t, r.Wc = n, r;
    }
    return __extends(n, e), n.prototype.Lc = function(t) {
        var e = new Re(t.serializer, re(t.serializer, this.Wc));
        return new Ue(t.path, e);
    }, n.prototype.isEqual = function(t) {
        // TODO(mrschmidt): Implement isEquals
        return this === t;
    }, n;
}(li), wi = /** @class */ function(e) {
    function n() {
        return e.call(this) || this;
    }
    return __extends(n, e), n.delete = function() {
        return Gr("FieldValue.delete", arguments), new bi(new pi("FieldValue.delete"));
    }, n.serverTimestamp = function() {
        return Gr("FieldValue.serverTimestamp", arguments), new bi(new yi("FieldValue.serverTimestamp"));
    }, n.arrayUnion = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
                return zr("FieldValue.arrayUnion", arguments, 1), new bi(new vi("FieldValue.arrayUnion", t));
    }, n.arrayRemove = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
                return zr("FieldValue.arrayRemove", arguments, 1), new bi(new gi("FieldValue.arrayRemove", t));
    }, n.increment = function(t) {
        return Kr("FieldValue.increment", "number", 1, t), jr("FieldValue.increment", arguments, 1), 
        new bi(new mi("FieldValue.increment", t));
    }, n;
}(li), bi = /** @class */ function(e) {
    function n(t) {
        var n = this;
...
}(wi), Ei = /** @class */ function() {
    function t(t, e) {
        if (jr("GeoPoint", arguments, 2), Kr("GeoPoint", "number", 1, t), Kr("GeoPoint", "number", 2, e), 
     ...
     */
    t.prototype.T = function(t) {
        return R$1(this.Qc, t.Qc) || R$1(this.jc, t.jc);
    }, t;
}(), Ii = /^__.*__$/, Ni = function(t, e, n) {
    ...
    return t.prototype.Hc = function(t, e) {
        var n = [];
        return null !== this.qe ? n.push(new Ke(t, this.data, this.qe, e)) : n.push(new Be(t, this.data, e)), 
    ...
    return t.prototype.Hc = function(t, e) {
        var n = [ new Ke(t, this.data, this.qe, e) ];
...
/** A "context" object passed around while parsing user data. */ var Di = /** @class */ function() {
    /**
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.Xc = function(e) {
        ...
        return Fi(t, this.settings.methodName, this.settings.nl || !1, this.path, this.settings.Mc);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (_i(this.Oc) && Ii.test(t)) throw this.qc('Document fields cannot begin and end with "__"');
    }, t;
}(), Vi = /** @class */ function() {
    function t(t, e, n) {
        this.s = t, this.ignoreUndefinedProperties = e, this.serializer = n || Sr(t)
        /** Creates a new top-level parse context. */;
    }
    return t.prototype.sl = function(t, e, n, r) {
        return void 0 === r && (r = !1), new Di({
            Oc: t,
            methodName: e,
            Mc: n,
            path: K$1.k(),
...
/** Parse document data from a set() call. */ function ki(t, e, n, r, i, o) {
    ...
    return new Ai(new Je(c), u, a);
}

/** Parse update data from an update() call. */ function Ri(t, e, n, r) {
    var i = t.sl(1 /* Update */ , e, n);
    qi("Data must be an object, but it was:", i, r);
    var o = [], s = new Ze;
    S$1(r, (function(t, r) {
        var u = Mi(e, t, n), a = i.tl(u);
        if (r instanceof li && r.kc instanceof pi) 
    ...
    var u = new Le(o);
    return new Ti(s.ze(), u, i.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function Oi(t, e, n, r, i, o) {
    var s = t.sl(1 /* Update */ , e, n), u = [ Ci(e, r, n) ], a = [ i ];
    ...
    for (var c = 0; c < o.length; c += 2) u.push(Ci(e, o[c])), a.push(o[c + 1]);
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (var h = [], f = new Ze, l = u.length - 1; l >= 0; --l) if (!xi(h, u[l])) {
        var p = u[l], d = a[l], y = s.tl(p);
        if (d instanceof li && d.kc instanceof pi) 
        // Add it to the field mask, but don't add anything to updateData.
        h.push(p); else {
            var v = Li(d, y);
    ...
    var g = new Le(h);
    return new Ti(f.ze(), g, s.fieldTransforms);
}
 ...
 */ function Pi(t, e, n, r) {
    return void 0 === r && (r = !1), Li(n, t.sl(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function Li(t, e) {
    if (Si(t)) return qi("Unsupported field value:", e, t), Ui(t, e);
    if (t instanceof li) 
    ...
    return function(t, e) {
        ...
        if (!_i(e.Oc)) throw e.qc(t.xc + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        if (t instanceof Ni) {
            ...
            return {
                referenceValue: ae(t.Gc || e.s, t.zc.path)
            };
        }
        if (void 0 === t && e.ignoreUndefinedProperties) return null;
        throw e.qc("Unsupported field value: " + Zr(t));
    }(t, e);
}
...
function Ui(t, e) {
    ...
    e.path && e.path.length > 0 && e.qe.push(e.path) : S$1(t, (function(t, r) {
        var i = Li(r, e.Jc(t));
        null != i && (n[t] = i);
    })), {
        mapValue: {
...
function Si(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof x$1 || t instanceof Ei || t instanceof ai || t instanceof Ni || t instanceof li);
}
 ...
 */ function Ci(t, e, n) {
    if (e instanceof ci) return e.$c;
    if ("string" == typeof e) return Mi(t, e);
 ...
 */ function Mi(t, e, n) {
    try {
        return function(t) {
            if (t.search(fi) >= 0) throw new F$1(M$1.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not contain '~', '*', '/', '[', or ']'");
            try {
                return new (hi.bind.apply(hi, __spreadArrays([ void 0 ], t.split("."))));
            } catch (e) {
 ...
 */ var Gi = /** @class */ function() {
    ...
    return t.prototype.al = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(o) {
                switch (o.label) {
                  case 0:
                    if (this.ul(), this.mutations.length > 0) throw new F$1(M$1.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
                    return [ 4 /*yield*/ , function(t, r) {
                        return __awaiter(this, void 0, void 0, (function() {
                            ...
                            return __generator(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return e = D$1(t), i = le(e.serializer) + "/documents", o = {
                  ...
                  case 1:
                    return [ 2 /*return*/ , ((r = o.sent()).forEach((function(t) {
                        t instanceof rn || t instanceof nn ? i.cl(t) : T$1();
                    })), r) ];
                }
            }));
        }));
        ...
        this.write([ new $e(t, this.Be(t)) ]), this.hl.add(t);
    ...
    t.prototype.Be = function(t) {
        ...
        return !this.hl.has(t) && e ? qe.updateTime(e) : qe.je();
    }, 
    /**
    ...
    function t(t, e, n, r) {
        this.Vs = t, this.xo = e, this.updateFunction = n, this.gs = r, this._l = 5, this.Os = new xn(this.Vs, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.run = function() {
        ...
        this.Os.fs((function() {
            return __awaiter(t, void 0, void 0, (function() {
                var t, e, r = this;
                return __generator(this, (function(n) {
                    return t = new Gi(this.xo), (e = this.dl(t)) && e.then((function(e) {
                        r.Vs.Cs((function() {
        ...
        try {
            ...
            return !Q$1(e) && e.catch && e.then ? e : (this.gs.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
     ...
     */
    e) {
        this.credentials = t, this.Vs = e, this.clientId = k$1.t(), 
    ...
    return t.prototype.start = function(t, e, n, r) {
        ...
        return this.credentials.kr((function(t) {
            if (!s) return s = !0, E$1("FirestoreClient", "Initializing. user=", t.uid), i.Il(e, n, r, t, o).then(i.ml.resolve, i.ml.reject);
            i.Vs.Gs((function() {
                return i.ha.yh(t);
            }));
        })), 
    ...
    t.prototype.El = function() {
        if (this.Vs.Ms) throw new F$1(M$1.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
                ...
                switch (e.label) {
                  ...
                  case 1:
                    return [ 2 /*return*/ , (e.sent(), function(t, e, n, r) {
                        var i = new Fn, o = Bi(t, e, an(n.path), {
                                        ...
                                        return __awaiter(s, void 0, void 0, (function() {
                                            ...
                                            return __generator(this, (function(n) {
                                                switch (n.label) {
                                                  ...
                                                  case 1:
                                                    return t = n.sent(), e = new vr(i, t._r), s = e.Kh(t.documents), u = e.Jh(s, 
    ...
    t.prototype.transaction = function(t) {
        ...
        var n = new Fn;
        return this.Vs.Cs((function() {
            return new ji(e.Vs, e.xo, t, n).run(), Promise.resolve();
        })), n.promise;
    }, t;
}();
...
var Ki = /** @class */ function() {
    ...
    return t.prototype.Sl = function(t) {
        ...
        var e = this, n = {};
        return S$1(t.fields || {}, (function(t, r) {
            n[t] = e.Sl(r);
        })), n;
    }, t.prototype.Nl = function(t) {
        return new Ei(Bt(t.latitude), Bt(t.longitude));
        ...
        var e = zt(t), n = new x$1(e.seconds, e.nanos);
        return this.timestampsInSnapshots ? n : n.toDate();
    }, t.prototype.Fl = function(t) {
        var e = z.$(t);
        _(be(e));
        var n = new L$1(e.get(1), e.get(3)), r = new W$1(e.p(5));
...
}(), Wi = Hn.oi, Qi = /** @class */ function() {
    function t(t) {
        var e, n, r, i;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new F$1(M$1.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
            this.host = "firestore.googleapis.com", this.ssl = !0;
        } else Qr("settings", "non-empty string", "host", t.host), this.host = t.host, Yr("settings", "boolean", "ssl", t.ssl), 
        this.ssl = null === (e = t.ssl) || void 0 === e || e;
        if (ei("settings", t, [ "host", "ssl", "credentials", "timestampsInSnapshots", "cacheSizeBytes", "experimentalForceLongPolling", "ignoreUndefinedProperties" ]), 
        ...
        Yr("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = Hn.ai; else {
            if (t.cacheSizeBytes !== Wi && t.cacheSizeBytes < Hn.hi) throw new F$1(M$1.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + Hn.hi);
    ...
    function t(r, i, o, s) {
        var u = this;
        if (void 0 === o && (o = new Cr), void 0 === s && (s = new Mr), this.xl = o, this.Ll = s, 
        this.Ol = null, 
        // Public for use in tests.
        // TODO(mikelehen): Use modularized initialization instead.
        this.ql = new Qn, this.INTERNAL = {
            delete: function() {
                return __awaiter(u, void 0, void 0, (function() {
                    return __generator(this, (function(t) {
                        switch (t.label) {
            ...
            var a = r;
            this.Ol = a, this.Gc = t.Bl(a), this.Wl = a.name, this.Ql = new rr(i);
        } else {
            var c = r;
            if (!c.projectId) throw new F$1(M$1.INVALID_ARGUMENT, "Must provide projectId");
            this.Gc = new L$1(c.projectId, c.database), 
            // Use a default persistenceKey that lines up with FirebaseApp.
            this.Wl = "[DEFAULT]", this.Ql = new nr;
        }
        this.jl = new Qi({});
    }
    return Object.defineProperty(t.prototype, "Gl", {
        get: function() {
            ...
            this.zl = new Vi(this.Gc, this.jl.ignoreUndefinedProperties)), this.zl;
        },
        enumerable: !1,
        configurable: !0
    }), t.prototype.settings = function(t) {
        jr("Firestore.settings", arguments, 1), Kr("Firestore.settings", "object", 1, t);
        var e = new Qi(t);
        if (this.Ul && !this.jl.isEqual(e)) throw new F$1(M$1.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.");
        ...
        var e, n;
        if (this.Ul) throw new F$1(M$1.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only call enablePersistence() before calling any other methods on a Firestore object.");
        var r = !1, i = !1;
        ...
        return __awaiter(this, void 0, void 0, (function() {
            var t, r = this;
            return __generator(this, (function(i) {
                if (void 0 !== this.Ul && !this.Ul.gl) throw new F$1(M$1.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
                return t = new Fn, [ 2 /*return*/ , (this.ql.Us((function() {
                    return __awaiter(r, void 0, void 0, (function() {
                        var e;
                        return __generator(this, (function(n) {
                            switch (n.label) {
        ...
        if (this.Ml(), Fr(t)) return this.Ul.Qa(t);
        Kr("Firestore.onSnapshotsInSync", "function", 1, t);
        var e = {
            next: t
        };
        return this.Ul.Qa(e);
        ...
        // eslint-disable-next-line @typescript-eslint/no-floating-promises
        this.Hl(new Cr, new Mr, {
            Vc: !1
        }), this.Ul;
    }, t.prototype.Jl = function() {
        return new P$1(this.Gc, this.Wl, this.jl.host, this.jl.ssl, this.jl.forceLongPolling);
    }, t.prototype.Hl = function(t, e, n) {
        var r = this.Jl();
        return this.Ul = new zi(this.Ql, this.ql), this.Ul.start(r, t, e, n);
    }, t.Bl = function(t) {
 ...
 */        if (!n || "string" != typeof n) throw new F$1(M$1.INVALID_ARGUMENT, "projectId must be a string in FirebaseApp.options");
        ...
        get: function() {
            if (!this.Ol) throw new F$1(M$1.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.Ol;
        },
        enumerable: !1,
        configurable: !0
    }), t.prototype.collection = function(t) {
        return jr("Firestore.collection", arguments, 1), Kr("Firestore.collection", "non-empty string", 1, t), 
        this.Ml(), new co(z.$(t), this, 
        /* converter= */ null);
    }, t.prototype.doc = function(t) {
        return jr("Firestore.doc", arguments, 1), Kr("Firestore.doc", "non-empty string", 1, t), 
        this.Ml(), Xi.Zl(z.$(t), this, 
        /* converter= */ null);
    }, t.prototype.collectionGroup = function(t) {
        if (jr("Firestore.collectionGroup", arguments, 1), Kr("Firestore.collectionGroup", "non-empty string", 1, t), 
        ...
        return this.Ml(), new uo(function(t) {
            return new un(z.k(), t);
        }(t), this, 
        /* converter= */ null);
    }, t.prototype.runTransaction = function(t) {
        var e = this;
        return jr("Firestore.runTransaction", arguments, 1), Kr("Firestore.runTransaction", "function", 1, t), 
        this.Ml().transaction((function(n) {
            return t(new Hi(e, n));
        }));
    }, t.prototype.batch = function() {
        return this.Ml(), new $i(this);
        ...
        var e;
        jr("Firestore.setLogLevel", arguments, 1), $r("setLogLevel", [ "debug", "error", "silent", "warn", "info", "verbose" ], 1, t), 
    ...
    return t.prototype.get = function(t) {
        ...
        var n = po("Transaction.get", t, this.e_);
        return this.n_.al([ n.zc ]).then((function(t) {
            if (!t || 1 !== t.length) return T$1();
            var r = t[0];
            if (r instanceof rn) return new Zi(e.e_, n.zc, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.Kc);
            if (r instanceof nn) return new Zi(e.e_, n.zc, r, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.Kc);
            throw T$1();
        }));
        ...
        var r = po("Transaction.set", t, this.e_);
        n = ho("Transaction.set", n);
        var i = vo(r.Kc, e, n), o = ki(this.e_.Gl, "Transaction.set", r.zc, i, null !== r.Kc, n);
        return this.n_.set(r.zc, o), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return "string" == typeof e || e instanceof hi ? (zr("Transaction.update", arguments, 3), 
        r = po("Transaction.update", t, this.e_), i = Oi(this.e_.Gl, "Transaction.update", r.zc, e, n, o)) : (jr("Transaction.update", arguments, 2), 
        r = po("Transaction.update", t, this.e_), i = Ri(this.e_.Gl, "Transaction.update", r.zc, e)), 
        this.n_.update(r.zc, i), this;
    }, t.prototype.delete = function(t) {
        jr("Transaction.delete", arguments, 1);
        var e = po("Transaction.delete", t, this.e_);
    ...
    return t.prototype.set = function(t, e, n) {
        Br("WriteBatch.set", arguments, 2, 3), this.r_();
        var r = po("WriteBatch.set", t, this.e_);
        n = ho("WriteBatch.set", n);
        var i = vo(r.Kc, e, n), o = ki(this.e_.Gl, "WriteBatch.set", r.zc, i, null !== r.Kc, n);
        return this.s_ = this.s_.concat(o.Hc(r.zc, qe.je())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return this.r_(), "string" == typeof e || e instanceof hi ? (zr("WriteBatch.update", arguments, 3), 
        r = po("WriteBatch.update", t, this.e_), i = Oi(this.e_.Gl, "WriteBatch.update", r.zc, e, n, o)) : (jr("WriteBatch.update", arguments, 2), 
        r = po("WriteBatch.update", t, this.e_), i = Ri(this.e_.Gl, "WriteBatch.update", r.zc, e)), 
        this.s_ = this.s_.concat(i.Hc(r.zc, qe.exists(!0))), this;
    }, t.prototype.delete = function(t) {
        jr("WriteBatch.delete", arguments, 1), this.r_();
        var e = po("WriteBatch.delete", t, this.e_);
        return this.s_ = this.s_.concat(new $e(e.zc, qe.je())), this;
    }, t.prototype.commit = function() {
        return this.r_(), this.i_ = !0, this.s_.length > 0 ? this.e_.Ml().write(this.s_) : Promise.resolve();
    }, t.prototype.r_ = function() {
        if (this.i_) throw new F$1(M$1.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}(), Xi = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
    ...
    return __extends(n, e), n.Zl = function(t, e, r) {
        ...
        get: function() {
            return new co(this.zc.path.g(), this.firestore, this.Kc);
        },
        enumerable: !1,
        configurable: !0
    }), Object.defineProperty(n.prototype, "path", {
        get: function() {
            return this.zc.path.N();
        },
        enumerable: !1,
        configurable: !0
    }), n.prototype.collection = function(t) {
        if (jr("DocumentReference.collection", arguments, 1), Kr("DocumentReference.collection", "non-empty string", 1, t), 
        !t) throw new F$1(M$1.INVALID_ARGUMENT, "Must provide a non-empty collection name to collection()");
        var e = z.$(t);
        return new co(this.zc.path.child(e), this.firestore, 
        /* converter= */ null);
    }, n.prototype.isEqual = function(t) {
        ...
        Br("DocumentReference.set", arguments, 1, 2), e = ho("DocumentReference.set", e);
        var n = vo(this.Kc, t, e), r = ki(this.firestore.Gl, "DocumentReference.set", this.zc, n, null !== this.Kc, e);
        return this.Ul.write(r.Hc(this.zc, qe.je()));
    }, n.prototype.update = function(t, e) {
        for (var n, r = [], i = 2; i < arguments.length; i++) r[i - 2] = arguments[i];
        return "string" == typeof t || t instanceof hi ? (zr("DocumentReference.update", arguments, 2), 
        n = Oi(this.firestore.Gl, "DocumentReference.update", this.zc, t, e, r)) : (jr("DocumentReference.update", arguments, 1), 
        n = Ri(this.firestore.Gl, "DocumentReference.update", this.zc, t)), this.Ul.write(n.Hc(this.zc, qe.exists(!0)));
    }, n.prototype.delete = function() {
        return jr("DocumentReference.delete", arguments, 0), this.Ul.write([ new $e(this.zc, qe.je()) ]);
        ...
        "object" != typeof i[u] || Fr(i[u]) || (ei("DocumentReference.onSnapshot", s = i[u], [ "includeMetadataChanges" ]), 
        Yr("DocumentReference.onSnapshot", "boolean", "includeMetadataChanges", s.includeMetadataChanges), 
        u++);
        var a = {
        ...
        } else Kr("DocumentReference.onSnapshot", "function", u, i[u]), Wr("DocumentReference.onSnapshot", "function", u + 1, i[u + 1]), 
        Wr("DocumentReference.onSnapshot", "function", u + 2, i[u + 2]);
        var h = {
            next: function(t) {
                i[u] && i[u](r.o_(t));
            },
        ...
        return this.Ul.listen(an(this.zc.path), a, h);
    }, n.prototype.get = function(t) {
        var e = this;
        Br("DocumentReference.get", arguments, 0, 1), lo("DocumentReference.get", t);
        var n = this.firestore.Ml();
        return t && "cache" === t.source ? n.Pl(this.zc).then((function(t) {
            return new Zi(e.firestore, e.zc, t, 
    ...
    n.prototype.o_ = function(t) {
        ...
        return new Zi(this.firestore, this.zc, e, t.fromCache, t.hasPendingWrites, this.Kc);
    }, n;
}(Ni), Ji = /** @class */ function() {
    function t(t, e) {
    ...
    return t.prototype.data = function(t) {
        var e = this;
        if (Br("DocumentSnapshot.data", arguments, 0, 1), t = fo("DocumentSnapshot.data", t), 
        this.h_) {
            // We only want to use the converter and create a new DocumentSnapshot
            // if a converter has been provided.
            if (this.Kc) {
                var n = new to(this.e_, this.zc, this.h_, this.a_, this.u_, 
                /* converter= */ null);
                return this.Kc.fromFirestore(n, t);
            }
            return new Ki(this.e_.Gc, this.e_.t_(), t.serverTimestamps || "none", (function(t) {
                return new Xi(t, e.e_, /* converter= */ null);
            })).Sl(this.h_.Ze());
        }
    }, t.prototype.get = function(t, e) {
        var n = this;
        if (Br("DocumentSnapshot.get", arguments, 1, 2), e = fo("DocumentSnapshot.get", e), 
        this.h_) {
            var r = this.h_.data().field(Ci("DocumentSnapshot.get", t, this.zc));
            if (null !== r) return new Ki(this.e_.Gc, this.e_.t_(), e.serverTimestamps || "none", (function(t) {
                return new Xi(t, n.e_, n.Kc);
            })).Sl(r);
        }
        ...
        get: function() {
            return new Xi(this.zc, this.e_, this.Kc);
        },
        enumerable: !1,
        configurable: !0
...
function eo(t, e, n, r, i, o, s) {
    ...
    } else "in" /* IN */ !== o && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== o || io(s, o), 
    u = Pi(n, e, s, "in" /* IN */ === o);
    ...
    return function(t, e) {
        ...
        if (e.ln()) {
            var s = t.cn();
            if (null !== s && !s.isEqual(e.field)) throw new F$1(M$1.INVALID_ARGUMENT, "Invalid query. All where filters with an inequality (<, <=, >, or >=) must be on the same field. But you have inequality filters on '" + s.toString() + "' and '" + e.field.toString() + "'");
            var u = t.un();
            null !== u && oo(t, e.field, u);
        } else if (o || i) {
            ...
            throw a === e.op ? new F$1(M$1.INVALID_ARGUMENT, "Invalid query. You cannot use more than one '" + e.op.toString() + "' filter.") : new F$1(M$1.INVALID_ARGUMENT, "Invalid query. You cannot use '" + e.op.toString() + "' filters with '" + a.toString() + "' filters.");
        }
    }(t, l), l;
}
...
function ro(t, e, n) {
    if ("string" == typeof n) {
        ...
        var r = e.path.child(z.$(n));
        if (!W$1.W(r)) throw new F$1(M$1.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + r + "' is not because it has an odd number of segments (" + r.length + ").");
        return Wt(t, new W$1(r));
    }
    if (n instanceof Ni) return Wt(t, n.zc);
    throw new F$1(M$1.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + Zr(n) + ".");
}
...
function so(t) {
    if (t.an() && 0 === t.tn.length) throw new F$1(M$1.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
var uo = /** @class */ function() {
    ...
    return t.prototype.where = function(e, n, r) {
        jr("Query.where", arguments, 3), ti("Query.where", 3, r);
        // Enumerated from the WhereFilterOp type in index.d.ts.
        var i = $r("Query.where", [ "<" /* LESS_THAN */ , "<=" /* LESS_THAN_OR_EQUAL */ , "==" /* EQUAL */ , ">=" /* GREATER_THAN_OR_EQUAL */ , ">" /* GREATER_THAN */ , "array-contains" /* ARRAY_CONTAINS */ , "in" /* IN */ , "array-contains-any" /* ARRAY_CONTAINS_ANY */ ], 2, n), o = Ci("Query.where", e), s = eo(this.c_, "Query.where", this.firestore.Gl, this.firestore.Gc, o, i, r);
        ...
        var r;
        if (Br("Query.orderBy", arguments, 1, 2), Wr("Query.orderBy", "non-empty string", 2, n), 
        ...
        var i = Ci("Query.orderBy", e), o = no(this.c_, i, r);
        return new t(function(t, e) {
        ...
        return jr("Query.limit", arguments, 1), Kr("Query.limit", "number", 1, e), ri("Query.limit", 1, e), 
        new t(ln(this.c_, e, "F" /* First */), this.firestore, this.Kc);
    }, t.prototype.limitToLast = function(e) {
        return jr("Query.limitToLast", arguments, 1), Kr("Query.limitToLast", "number", 1, e), 
        ri("Query.limitToLast", 1, e), new t(ln(this.c_, e, "L" /* Last */), this.firestore, this.Kc);
        ...
        if (!(e instanceof t)) throw ni("isEqual", "Query", 1, e);
    ...
    /** Helper function to create a bound from a document or fields */ t.prototype.l_ = function(t, e, n, i) {
        if (ti(t, 1, e), e instanceof Zi) return jr(t, __spreadArrays([ e ], n), 1), function(t, e, n, r, i) {
            ...
            for (var o = [], s = 0, u = hn(t); s < u.length; s++) {
                var a = u[s];
                if (a.field.O()) o.push(Wt(e, r.key)); else {
                    var c = r.field(a.field);
                    if (Ut(c)) throw new F$1(M$1.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + a.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                    if (null === c) {
                        var h = a.field.N();
        ...
        return function(t, e, n, r, i, o) {
            ...
            for (var u = [], a = 0; a < i.length; a++) {
                ...
                if (s[a].field.O()) {
                    ...
                    var h = t.path.child(z.$(c));
                    if (!W$1.W(h)) throw new F$1(M$1.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + r + "() must result in a valid document path, but '" + h + "' is not because it contains an odd number of segments.");
                    var f = new W$1(h);
                    u.push(Wt(e, f));
                } else {
                    var l = Pi(n, r, c);
        ...
        var s = {}, u = 0;
        if ("object" != typeof i[u] || Fr(i[u]) || (ei("Query.onSnapshot", s = i[u], [ "includeMetadataChanges" ]), 
        Yr("Query.onSnapshot", "boolean", "includeMetadataChanges", s.includeMetadataChanges), 
        u++), Fr(i[u])) {
            var a = i[u];
        ...
        } else Kr("Query.onSnapshot", "function", u, i[u]), Wr("Query.onSnapshot", "function", u + 1, i[u + 1]), 
        Wr("Query.onSnapshot", "function", u + 2, i[u + 2]);
        var c = {
            next: function(t) {
                i[u] && i[u](new ao(r.firestore, r.c_, t, r.Kc));
            },
            error: i[u + 1],
            complete: i[u + 2]
        };
        return so(this.c_), this.firestore.Ml().listen(this.c_, s, c);
    }, t.prototype.get = function(t) {
        var e = this;
        Br("Query.get", arguments, 0, 1), lo("Query.get", t), so(this.c_);
        var n = this.firestore.Ml();
        return (t && "cache" === t.source ? n.pl(this.c_) : n.yl(this.c_, t)).then((function(t) {
            return new ao(e.firestore, e.c_, t, e.Kc);
        }));
    }, t;
}(), ao = /** @class */ function() {
    function t(t, e, n, r) {
    ...
    return Object.defineProperty(t.prototype, "docs", {
        ...
        var n = this;
        Br("QuerySnapshot.forEach", arguments, 1, 2), Kr("QuerySnapshot.forEach", "function", 1, t), 
        this.f_.docs.forEach((function(r) {
            t.call(e, n.T_(r, n.metadata.fromCache, n.f_.qt.has(r.key)));
        }));
    }, Object.defineProperty(t.prototype, "query", {
        get: function() {
            return new uo(this.__, this.e_, this.Kc);
        },
        enumerable: !1,
        configurable: !0
    }), t.prototype.docChanges = function(t) {
        t && (ei("QuerySnapshot.docChanges", t, [ "includeMetadataChanges" ]), Yr("QuerySnapshot.docChanges", "boolean", "includeMetadataChanges", t.includeMetadataChanges));
        var e = !(!t || !t.includeMetadataChanges);
        if (e && this.f_.Ut) throw new F$1(M$1.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
    ...
    /** Check the equality. The call can be very expensive. */ t.prototype.isEqual = function(e) {
        ...
        return new to(this.e_, t.key, t, e, n, this.Kc);
    }, t;
}(), co = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        if ((i = e.call(this, an(t), n, r) || this).m_ = t, t.length % 2 != 1) throw new F$1(M$1.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t.N() + " has " + t.length);
        return i;
    }
    return __extends(n, e), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            ...
            return t._() ? null : new Xi(new W$1(t), this.firestore, 
            /* converter= */ null);
        },
        enumerable: !1,
        configurable: !0
        ...
        Br("CollectionReference.doc", arguments, 0, 1), 
        // We allow omission of 'pathString' but explicitly prohibit passing in both
        // 'undefined' and 'null'.
        0 === arguments.length && (t = k$1.t()), Kr("CollectionReference.doc", "non-empty string", 1, t);
        var e = z.$(t);
        return Xi.Zl(this.c_.path.child(e), this.firestore, this.Kc);
    }, n.prototype.add = function(t) {
        jr("CollectionReference.add", arguments, 1), Kr("CollectionReference.add", "object", 1, this.Kc ? this.Kc.toFirestore(t) : t);
        var e = this.doc();
...
function ho(t, e) {
    ...
    if (ei(t, e, [ "merge", "mergeFields" ]), Yr(t, "boolean", "merge", e.merge), function(t, e, n, r, i) {
        void 0 !== r && function(t, e, n, r, i) {
            if (!(r instanceof Array)) throw new F$1(M$1.INVALID_ARGUMENT, "Function " + t + "() requires its " + e + " option to be an array, but it was: " + Zr(r));
            for (var o = 0; o < r.length; ++o) if (!i(r[o])) throw new F$1(M$1.INVALID_ARGUMENT, "Function " + t + "() requires all " + e + " elements to be " + n + ", but the value at index " + o + " was: " + Zr(r[o]));
        }(t, e, n, r, i);
...
function fo(t, e) {
    return void 0 === e ? {} : (ei(t, e, [ "serverTimestamps" ]), Hr(t, 0, "serverTimestamps", e.serverTimestamps, [ "estimate", "previous", "none" ]), 
    e);
}

function lo(t, e) {
    Wr(t, "object", 1, e), e && (ei(t, e, [ "source" ]), Hr(t, 0, "source", e.source, [ "default", "server", "cache" ]));
}
...
var go = {
    ...
    Transaction: Hi,
    WriteBatch: $i,
    DocumentReference: Xi,
    DocumentSnapshot: Zi,
    Query: uo,
    QueryDocumentSnapshot: to,
    QuerySnapshot: ao,
    CollectionReference: co,
    FieldPath: hi,
    FieldValue: wi,
 ...
 */ function mo(t) {
    !function(t, e) {
        t.INTERNAL.registerComponent(new Component("firestore", (function(t) {
            return function(t, e) {
                return new Yi(t, e, new Cr, new Mr);
            }(t.getProvider("app").getImmediate(), t.getProvider("auth-internal"));
        }), "PUBLIC" /* PUBLIC */).setServiceProps(Object.assign({}, go)));
